...
#define MAXMATRIX_USE_SPI                                           STD_ON
#define MAXMATRIX_USE_DIGITAL_WRITE_FAST                            STD_ON
...
class MaxMatrix
{
  ...
  public:
    ...
    stdReturnType setRowOnAllModules(byte, byte);
    ...
    void shiftLeft(bool = false, bool = true, bool = false);
    void shiftRight(bool = false, bool = true, bool = false);
    void shiftUp(bool = false, bool = false);
    void shiftDown(bool = false, bool = false);
};
