...
typedef enum {
    MAXMATRIX_ORIENTATION_0,
    MAXMATRIX_ORIENTATION_90,
    MAXMATRIX_ORIENTATION_180,
    MAXMATRIX_ORIENTATION_270
} MaxMatrixOrientationType;
...
class MaxMatrix
{
  private:
    ...
    MaxMatrixOrientationType Orientation;

    void reload();
    void charShiftTask();
    void stringShiftTask();
    stdReturnType convertCharToSprite(char Char, spriteIndexType* SpriteIndex);
    stdReturnType print(byte Column, byte Value, MaxMatrixOrientationType Orientation);
	...
	stdReturnType setRowLL(byte, rowType*);
  ...
  public:
	...
	MaxMatrixOrientationType getOrientation() { return Orientation; }
	...
	stdReturnType setRow(byte, rowType*);
