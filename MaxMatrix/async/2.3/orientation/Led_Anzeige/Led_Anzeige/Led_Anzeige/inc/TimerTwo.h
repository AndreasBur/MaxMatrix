...
#define TIMERTWO_OC2A_ARDUINO_PIN					11
/* OC2B Chip Pin 5, Pin name PD3 */
#define TIMERTWO_OC2B_ARDUINO_PIN					3
...
typedef enum {
	TIMERTWO_PWM_PIN_11  = 11,
	TIMERTWO_PWM_PIN_2   = 3
} TimerTwoPwmPinType;
...
class TimerTwo
{
  ...
  public:
	...
	stdReturnType enablePwm(TimerTwoPwmPinType PwmPin, int DutyCylce, long Microseconds = -1);
	stdReturnType disablePwm(TimerTwoPwmPinType PwmPin);
	stdReturnType setPwmDuty(TimerTwoPwmPinType PwmPin, int DutyCycle);
	stdReturnType start();
	void stop();
