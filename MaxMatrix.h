...
//#define MAXMATRIX_MODULES_BUFFER_LENGTH								(MAXMATRIX_NUMBER_OF_MODULES * MAXMATRIX_COLUMN_NUMBER_OF_MODULE)
...
class MaxMatrix
{
  ...
  public:
    ...
    stdReturnType setColumnOnAllModules(byte, byte);
    stdReturnType setDot(byte, byte, byte);
	stdReturnType printChar(int, int, char);
	stdReturnType printCharWithShift(char);
	stdReturnType printStringWithShift(char*);
	stdReturnType getSprite(spriteIndexType, spriteType*);
	void printSprite(int, int, const spriteType*);
